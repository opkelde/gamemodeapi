...
public class DiscoveryPayloadBuilder
{
    ...
    private object BuildDeviceBlock()
    {
        return new
        {
            identifiers = new[] { $"GameDetect_{_deviceId}" },
            name = _serviceSettings.DeviceName,
            model = "GameDetect Client",
            manufacturer = "GameDetect",
    ...
    public string BuildGameModePayload()
    {
        ...
        {
            name = "Game Status",
            unique_id = $"GameDetect_{_deviceId}_game_mode",
    ...
    public string BuildActiveGamePayload()
    {
        ...
        {
            name = "Active Game",
            unique_id = $"GameDetect_{_deviceId}_active_game",
